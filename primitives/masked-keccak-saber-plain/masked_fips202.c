...
void KeccakF1600_StatePermute_masked(uint64_t state_masked[25 * NSHARES])
{
    int round, i;

    uint64_t Aba[NSHARES], Abe[NSHARES], Abi[NSHARES], Abo[NSHARES], Abu[NSHARES];
    uint64_t Aga[NSHARES], Age[NSHARES], Agi[NSHARES], Ago[NSHARES], Agu[NSHARES];
    uint64_t Aka[NSHARES], Ake[NSHARES], Aki[NSHARES], Ako[NSHARES], Aku[NSHARES];
    uint64_t Ama[NSHARES], Ame[NSHARES], Ami[NSHARES], Amo[NSHARES], Amu[NSHARES];
    uint64_t Asa[NSHARES], Ase[NSHARES], Asi[NSHARES], Aso[NSHARES], Asu[NSHARES];
    uint64_t BCa[NSHARES], BCe[NSHARES], BCi[NSHARES], BCo[NSHARES], BCu[NSHARES];
    uint64_t Da[NSHARES],  De[NSHARES],  Di[NSHARES],  Do[NSHARES],  Du[NSHARES];
    uint64_t Eba[NSHARES], Ebe[NSHARES], Ebi[NSHARES], Ebo[NSHARES], Ebu[NSHARES];
    uint64_t Ega[NSHARES], Ege[NSHARES], Egi[NSHARES], Ego[NSHARES], Egu[NSHARES];
    uint64_t Eka[NSHARES], Eke[NSHARES], Eki[NSHARES], Eko[NSHARES], Eku[NSHARES];
    uint64_t Ema[NSHARES], Eme[NSHARES], Emi[NSHARES], Emo[NSHARES], Emu[NSHARES];
    uint64_t Esa[NSHARES], Ese[NSHARES], Esi[NSHARES], Eso[NSHARES], Esu[NSHARES];
...
**************************************************/
 void keccak_absorb_masked(uint64_t s_masked[25 * NSHARES],
                           unsigned int r,
...
void shake128_masked(uint8_t* out_masked, size_t outlen, const uint8_t* in_masked, size_t inlen)
{
    ...
    uint8_t t_masked[SHAKE128_RATE*NSHARES];
...
void shake256_masked(uint8_t* out_masked, size_t outlen, const uint8_t* in_masked, size_t inlen)
{
    ...
    uint8_t t_masked[SHAKE256_RATE*NSHARES];
    keccak_state_masked state_masked;
...
*              - size_t inlen:      length of input in bytes
**************************************************/
void sha3_256_masked(uint8_t h_masked[32*NSHARES], const uint8_t* in_masked, size_t inlen)
{
    unsigned int i,l;
    uint64_t s_masked[25*NSHARES];
    uint8_t t_masked[SHA3_256_RATE*NSHARES];
...
*              - size_t inlen:      length of input in bytes
**************************************************/
void sha3_512_masked(uint8_t h_masked[64 * NSHARES], const uint8_t* in_masked, size_t inlen)
{
    unsigned int i,l;
    uint64_t s_masked[25 * NSHARES];
    uint8_t t_masked[SHA3_512_RATE*NSHARES];
